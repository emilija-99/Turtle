import { AfterContentInit, Component, Input, model, OnChanges, OnInit, SimpleChanges } from '@angular/core';
...
export class HabitTrackerComponent implements OnInit, OnChanges, AfterContentInit {
